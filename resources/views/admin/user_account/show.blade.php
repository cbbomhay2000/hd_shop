...
@section('content')
        ...
        <section class="wrapper">
            ...
            <div class="main-body">
                <div class="row gutters-sm">
                    <form action="{{ Route('admin.user-account.update', $user) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="col-md-3 ">
                            <div class="card">
                                <div class="card-body background">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="{{ asset('images/' . $user->image) }}"  alt="user"
    ...
    <script>
        $('#file').ijaboCropTool({
            ...
            processUrl: '{{ Route('admin.image', $user) }}',
